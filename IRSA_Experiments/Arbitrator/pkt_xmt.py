...
import pkt_xmt_epy_block_2_1 as epy_block_2_1  # embedded python block
...
class pkt_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='file.txt', iq1_1='iq_samplesTX1.csv', iq1_2='iq_badd1.csv', iq2_1='iq_samplesTX2.csv', iq2_2='iq_badd2.csv', iq_add='iq_Aadd.csv', log_file1='data_tx1.csv', log_file2='data_tx2.csv', timestamp1_1='timestamps1_1.txt', timestamp1_2='timestampsTx1_2.txt', timestamp2_1='timestamps2_1.txt', timestamp2_2='timestampsTx2_2.txt', timestamp_add='timestamp_add.txt'):
        ...
        self.epy_block_2_1 = epy_block_2_1.Random_Packet_Generator(mean_interval=2.7, packet_size=52, user_id=2, log_file=log_file1, total_packets=5)
        self.epy_block_2 = epy_block_2.Random_Packet_Generator(mean_interval=0.6, packet_size=52, user_id=1, log_file=log_file1, total_packets=5)
        ...
        self.blocks_tag_debug_0_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'tx2', "")
        ...
        self.msg_connect((self.epy_block_2_1, 'pdu_out'), (self.pdu_pdu_to_tagged_stream_0_0, 'pdus'))
    ...
    def set_log_file1(self, log_file1):
        ...
        self.epy_block_2_1.log_file = self.log_file1
