...
import TX_c_epy_block_1 as epy_block_1  # embedded python block
import TX_c_epy_block_2 as epy_block_2  # embedded python block
import TX_c_epy_block_2_0 as epy_block_2_0  # embedded python block
import TX_c_epy_block_3_0 as epy_block_3_0  # embedded python block
import sip
import threading
...
class TX_c(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, Infile='log.txt', iq='iqRx.csv', iq1_1='iq_samplesTX1.csv', iq1_2='iq_badd1.csv', iq2_1='iq_samplesTX2.csv', iq2_2='iq_badd2.csv', iq_add='iq_Aadd.csv', log_file1='data_tx1.csv', log_file2='data_tx2.csv', output_filename='output.bin', rx_log='rx_log.csv', timestamp='timestampsRx.txt'):
        ...
        self.epy_block_2 = epy_block_2.Random_Packet_Generator(mean_interval=0.02, packet_size=52, user_id=1, log_file=log_file1, total_packets=20, initial_delay=0)
        self.epy_block_1 = epy_block_1.iq_logger_with_timestamp(iq_csv_filename=iq1_1)
        self.epy_block_0_0 = epy_block_0_0.blk(log_file=rx_log, preamble_present=True)
        self.epy_block_0 = epy_block_0.PDU_to_Timed_Byte_Stream()
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, (8*sps))
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_crc32_async_bb_0, 'out'), (self.epy_block_0, 'pdus'))
        self.msg_connect((self.epy_block_0_0, 'pdu_out'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.epy_block_2, 'pdu_out'), (self.digital_crc32_async_bb_0, 'in'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0, 'pdus'), (self.blocks_message_debug_0, 'print'))
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0, 'pdus'), (self.epy_block_0_0, 'pdu_in'))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.epy_block_1, 0))
        self.connect((self.blocks_repack_bits_bb_1_0, 0), (self.digital_crc32_bb_0, 0))
        ...
        self.connect((self.epy_block_0, 1), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.epy_block_0, 0), (self.digital_constellation_modulator_0_0, 0))
        ...
        self.connect((self.epy_block_3_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.epy_block_3_0, 0), (self.digital_fll_band_edge_cc_0, 0))
        self.connect((self.fft_filter_xxx_0_0_0, 0), (self.epy_block_3_0, 0))
    ...
    def set_rx_log(self, rx_log):
        self.rx_log = rx_log
        self.epy_block_0_0.log_file = self.rx_log
    ...
    def set_sps(self, sps):
        ...
        self.blocks_repeat_0.set_interpolation((8*self.sps))
...
def main(top_block_cls=TX_c, options=None):
    ...
    tb = top_block_cls(Infile=options.Infile, iq=options.iq, iq1_1=options.iq1_1, iq1_2=options.iq1_2, iq2_1=options.iq2_1, iq2_2=options.iq2_2, iq_add=options.iq_add, log_file1=options.log_file1, log_file2=options.log_file2, output_filename=options.output_filename, rx_log=options.rx_log, timestamp=options.timestamp)
