...
import hackRF_epy_block_1 as epy_block_1  # embedded python block
import hackRF_epy_block_2 as epy_block_2  # embedded python block
import sip
import threading
...
class hackRF(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, iq1_1='iq_samplesTX1.csv', iq1_2='iq_badd1.csv', iq2_1='iq_samplesTX2.csv', iq2_2='iq_badd2.csv', iq_add='iq_Aadd.csv', log_file1='data_tx1.csv', log_file2='data_tx2.csv'):
        gr.top_block.__init__(self, "TX1_hackRF", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("TX1_hackRF")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "hackRF")
        ...
        self.usrp_rate = usrp_rate = 2*(10**6)
        self.bw = bw = (samp_rate//sps)*(1+excess_bw)
        self.access_key = access_key = '10101010101010101010101011100001010110101110100010010011'
        self.user_id1 = user_id1 = 1
        self.samp_rate1 = samp_rate1 = 48000
        self.rs_ratio = rs_ratio = samp_rate/usrp_rate
        self.low_pass_filter_taps = low_pass_filter_taps = firdes.low_pass(1.0, samp_rate, int(bw//2), 50e3, window.WIN_HAMMING, 6.76)
        self.hdr_format = hdr_format = digital.header_format_default(access_key, 0)
        self.fc = fc = 915e6
        self.bpsk = bpsk = digital.constellation_bpsk().base()
        self.bpsk.set_npwr(1.0)
        self.amp_norm = amp_norm = 0.5

        ##################################################
        # Blocks
        ##################################################

        self._amp_norm_range = qtgui.Range(0.1, 1, 0.1, 0.5, 200)
        self._amp_norm_win = qtgui.RangeWidget(self._amp_norm_range, self.set_amp_norm, "'amp_norm'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._amp_norm_win)
        ...
        self.soapy_hackrf_sink_1 = soapy.sink(dev, "fc32", 1, 'driver=hackrf',
                                  stream_args, tune_args, settings)
        self.soapy_hackrf_sink_1.set_sample_rate(0, usrp_rate)
        self.soapy_hackrf_sink_1.set_bandwidth(0, 0)
        self.soapy_hackrf_sink_1.set_frequency(0, fc)
        self.soapy_hackrf_sink_1.set_gain(0, 'AMP', False)
        self.soapy_hackrf_sink_1.set_gain(0, 'VGA', min(max(47, 0.0), 47.0))
        ...
        self.epy_block_2 = epy_block_2.Random_Packet_Generator(mean_interval=10, packet_size=20, user_id=1, log_file=log_file1, total_packets=20)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(amp_norm)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_tag_debug_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.soapy_hackrf_sink_1, 0))
        ...
        self.connect((self.fft_filter_xxx_0_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.fft_filter_xxx_0_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.fft_filter_xxx_0_0_0, 0), (self.qtgui_time_sink_x_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_bw((self.samp_rate//self.sps)*(1+self.excess_bw))
        self.set_low_pass_filter_taps(firdes.low_pass(1.0, self.samp_rate, int(self.bw//2), 50e3, window.WIN_HAMMING, 6.76))
        self.set_rs_ratio(self.samp_rate/self.usrp_rate)
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.set_rs_ratio(self.samp_rate/self.usrp_rate)
        self.qtgui_time_sink_x_1.set_samp_rate(self.usrp_rate)
        self.qtgui_time_sink_x_1_0.set_samp_rate(self.usrp_rate)
        self.soapy_hackrf_sink_1.set_sample_rate(0, self.usrp_rate)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.soapy_hackrf_sink_1.set_frequency(0, self.fc)
    ...
    def get_amp_norm(self):
        return self.amp_norm

    def set_amp_norm(self, amp_norm):
        self.amp_norm = amp_norm
        self.blocks_multiply_const_vxx_0.set_k(self.amp_norm)
...
def main(top_block_cls=hackRF, options=None):
    ...
    tb = top_block_cls(iq1_1=options.iq1_1, iq1_2=options.iq1_2, iq2_1=options.iq2_1, iq2_2=options.iq2_2, iq_add=options.iq_add, log_file1=options.log_file1, log_file2=options.log_file2)
