...
class stream_randomizer(gr.sync_block):
    def __init__(self, sample_rate=768000, mean_interval_ms=100.0):
        ...
        self.mean_interval_ms = mean_interval_ms          # mean of exponential distribution
    ...
    def _draw_gap_samples(self):
        """Draw gap from Exp(1/mean) and convert to samples."""
    ...
    def work(self, input_items, output_items):
        ...
        return n_written
"""
## How to tune `mean_interval_ms`

The offered load `G` in ALOHA is:

G = packet_duration / mean_interval
  = 44.4 ms / mean_interval_ms
"""
